...
var join = function() {
  ...
  function RouterStore(history, basePath) {
    var _this = this;
    !function(instance, Constructor) {
      if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
    }(this, RouterStore), this.history = history, this.basePath = basePath, this.pathList = [], 
    this.state = {
      action: Action.Pop,
      location: {
        key: "default",
    ...
    }, this.go = void 0, this.back = void 0, this.forward = void 0, this.updateState = action((function(newState) {
    ...
    })), this.subscribe = void 0, this.stopSyncWithHistory = void 0, this.go = history.go.bind(history), 
    this.back = history.back.bind(history), this.forward = history.forward.bind(history), 
    makeObservable(this, {
      state: observable,
      location: computed,
      query: computed,
